  ...
  <div className="max-w-6xl mx-auto px-4 py-12 animate-in fade-in-50 duration-700">
    <div className="text-center mb-12">
      ...
      <p className="text-lg text-slate-600">
        Based on your assessment, these **{MOCK_THERAPISTS.length}{" "}
        professionals** are highly compatible.
      </p>
    ...
    switch (appState) {
      case APP_STATE.WELCOME:
        return (
          <WelcomeStep
            onStart={() =>
              setAppState(isLoggedIn ? APP_STATE.WIZARD : APP_STATE.AUTH)
            }
      ...
      case APP_STATE.DASHBOARD:
        return (
          <Dashboard
            ...
            onOpenTherapistOnboarding={handleOpenTherapistOnboarding} // <-- NEW PROP
          />
        );
